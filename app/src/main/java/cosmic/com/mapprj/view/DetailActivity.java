...
public class DetailActivity extends AppCompatActivity {
    ...
    final static String TAG = "DATAACTivity";

    Button likeButton, hateButton;
    Button writeButton;
    Button allButton,bookingButton;;
    TextView likeCountView, hateCountView;
    ListView listView;
    TextView text1, text2;
    ImageButton kakaoLoginButton,facebookLoginButton;
...
//                        .into( imageViewTarget );
    ...
    public void requestDetailData(String title) {
        this.aaa=title;
        Log.d( TAG,"확인타이틀:"+title );
        requestDetailData();
    }
}